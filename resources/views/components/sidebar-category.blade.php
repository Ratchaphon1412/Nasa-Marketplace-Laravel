<aside class="w-full p-6 sm:w-60  text-gray-100">
	<nav class="space-y-8 text-sm">
		<div class="space-y-2">
			<h2 class="text-sm font-semibold tracki uppercase text-gray-400">Getting Started</h2>
		...
		<div class="space-y-2">
			<h2 class="text-sm font-semibold tracki uppercase text-gray-400">Dashboard</h2>
			<div class="flex flex-col space-y-1">
		...
		<div class="space-y-2">
			<h2 class="text-sm font-semibold tracki uppercasetext-gray-400">Pages</h2>
			<div class="flex flex-col space-y-1">
		...
		<div class="space-y-2">
			<h2 class="text-sm font-semibold tracki uppercase text-gray-400">Misc</h2>
			<div class="flex flex-col space-y-1">
