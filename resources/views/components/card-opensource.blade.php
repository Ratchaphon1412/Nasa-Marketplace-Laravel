...
<div class="relative  min-h-full flex flex-col items-center justify-center py-2">
    <div class="container">
    <div class="max-w-sm w-full bg-gray-900 shadow-lg rounded-xl p-8">
        ...
        <a href="{{route('marketplace.details',['project'=>$project])}}">
            ...
            <div class="absolute flex flex-col top-0 right-0 p-3">
                ...
                <img src="{{url('storage/app/'.$project->image_poster)}}" class=" w-full   object-fill  rounded-2xl transition-transform transform hover:scale-110">
            </div>
